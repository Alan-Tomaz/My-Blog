            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Wild Life</td>
                        <td><a href="<?php echo ROOT_URL ?>admin/pages/edit-post.php" class="btn sm">Edit</a></td>
                        <td><a href="<?php echo ROOT_URL ?>admin/pages/delete-post.php" class="btn sm danger">Delete</a></td>
                    </tr>
