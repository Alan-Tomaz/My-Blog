...
if (isset($_POST["submit"])) {
    ...
    */
    ...
    if (!$firstname) {
        ...
        $_SESSION["add-user"] = "Please Enter a Valid Location";
    } else if (!$bio) {
        $_SESSION["add-user"] = "Please Enter a Biography";
    ...
    if (isset($_SESSION["add-user"])) {
        ...
        header("location:" . ROOT_URL . "admin/pages/add-user.php");
        die();
    } else {
        // insert new user into users table
        $insertUserQuery = "INSERT INTO users (firstname, lastname, username, email, location, biography, password, avatar, is_admin) VALUES ('$firstname', '$lastname', '$username', '$email', '$location', '$bio', '$hashedPassword', '$avatarName', '$isAdmin')";
